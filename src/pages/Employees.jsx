          ...
          <div className="bg-white rounded-2xl p-6 mb-4 shadow-lg border border-blue-200 text-[12px] text-gray-800">
            ...
            <div className="flex gap-3">
              <button
                onClick={handleSave}
                disabled={loading}
                className="flex items-center gap-2 px-6 py-2 bg-gray-200 text-gray-700 text-[12px] rounded-lg hover:bg-gray-300 transition"
              >
              ...
              <tbody className="divide-y divide-gray-200 text-[12px]">
                {filteredEmployees.length > 0 ? (
                  filteredEmployees.map((emp) => (
                    <tr key={emp.id} className="hover:bg-green-50 transition-all duration-200 group">
                      <td className="px-6 py-2 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            <div className="text-[12px] font-semibold text-gray-900 group-hover:text-green-600">{emp.name}</div>
