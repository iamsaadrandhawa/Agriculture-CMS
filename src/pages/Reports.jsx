...
export default function DailyReport() {
  ...
  const handleViewPDF = () => {
    try {
      ...
      doc.setFontSize(18);
      doc.text("Agricultre CMS", 300, 40, { align: "center" });
      doc.setFontSize(14);
      ...
      // ===== METADATA =====
      doc.setProperties({
        title: "Agricultre CMS Monthly Financial Report",
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        doc.text("Generated by Agricultre CMS System", 40, doc.internal.pageSize.getHeight() - 20);
      }
  ...
  const handleDownloadPDF = () => {
    try {
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        doc.text("Generated by Agricultre CMS System", 80, doc.internal.pageSize.getHeight() - 20);
      }

      // ===== SAVE PDF =====
      doc.save(`Agricultre CMS_Monthly_Report_${monthName}_${selectedMonth}.pdf`);
